  ...
  ──────────────           ───────────────                 ────────────────
        ...
        <section id="screens" class="help-card help-section">
            ...
            <table class="table help">
                ...
                <tr><th>Devices</th><td>Each device's online status, name/location, IN/OUT direction, and which DMPI device it's linked to. Set direction + link here, and use <strong>Sync enrollments</strong> to push users to a device. The <strong>People</strong> column shows two numbers side by side — what this server has <em>sent</em> to the clock, and what payroll <em>assigns</em> to it — because they disagree whenever a sync is owed or somebody can't be enrolled, and that disagreement is the thing worth seeing. Alongside them, <span class="badge bg-warning text-dark">N waiting</span> (still in the mailbox, still cancellable) and <span class="badge bg-secondary">N unconfirmed</span> (already handed over, too late to stop). Every one of those is a link into the screens below.</td></tr>
                <tr><th>Devices → People</th><td>Who is on one clock, person by person: name, PIN, company, CHAPA, card, payroll id, and their punch count on that reader. Each row is <strong>on the clock</strong>, <strong>waiting to be added</strong>, <strong>waiting to be removed</strong>, or <strong>can't be added</strong> — that last one carrying its own cause and fix (no employee record here, or a PIN two people claim). Read "on the clock" as <em>we sent them</em>, never as <em>confirmed present</em>: a reader unplugged for a fortnight still has those changes sitting in its mailbox.</td></tr>
