  ...
  ──────────────           ───────────────                 ────────────────
        ...
        <section id="screens" class="help-card help-section">
            ...
            <table class="table help">
                ...
                <tr><th>Devices → Timekeeper devices</th><td>Payroll's device register, from payroll's side — reached from <strong>See who's on each</strong>. Every DMPI device with how many people it assigns, how many of those could actually be enrolled, and which of your readers is linked. Click one to see the people themselves. Crucially this works <strong>before</strong> a reader is linked, which is the question you have when choosing: previously the only way to see what was behind a device code was to point a reader at it and find out. A device with nobody assigned is flagged rather than shown as a quiet zero — linking a clock to one <em>empties that clock</em>.</td></tr>
