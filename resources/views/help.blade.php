  ...
  ──────────────           ───────────────                 ────────────────
        ...
        <section id="screens" class="help-card help-section">
            ...
            <table class="table help">
                ...
                <tr><th>Devices → People</th><td>ADMS's intended list for one clock, person by person: name, PIN, company, CHAPA, card, payroll id, and their punch count on that reader. <strong>Recorded for clock</strong> means ADMS queued or sent the user; it is not proof the physical reader applied the command. Other rows show <strong>waiting to be added</strong>, <strong>waiting to be removed</strong>, or <strong>can't be added</strong> with the cause.</td></tr>
